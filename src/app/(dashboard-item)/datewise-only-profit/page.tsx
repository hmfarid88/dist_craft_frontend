...
const Page = () => {
    ...
    useEffect(() => {
        fetch(`${apiBaseUrl}/api/getDatewiseOnlyProfitSale?username=${username}&startDate=${startDate}&endDate=${endDate}`)
        ...
        <div className="container-2xl min-h-[calc(100vh-228px)]">
            ...
            <div className="flex justify-between pl-5 pr-5 pt-5">
                ...
                <div className="flex gap-3">
                    <ExcelExportButton tableRef={contentToPrint} fileName="Profit_Report" />
                    <button onClick={handlePrint} className='btn btn-ghost btn-square'><FcPrint size={36} /></button>
                </div>
            </div>
            <div ref={contentToPrint} className="flex flex-col p-2 items-center justify-center">
                <CompanyInfo />
                <h4 className="font-bold">PROFIT REPORT</h4>
