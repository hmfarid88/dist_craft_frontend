        ...
        <div className='container-2xl'>
            <div className="grid grid-cols-1 md:grid-cols-2 items-center justify-center h-screen p-5">
                <div className="flex items-center justify-center bg-base-100">
                    <div>
                        <FcHeatMap size={50} className='bnt btn-ghost rounded-md border border-cyan-500' /><span className='text-3xl font-extrabold font-sans'>DIST</span> <span className='text-3xl font-extrabold text-accent font-sans'>CRAFT</span>
